...
- Save the first OLL and PLL cases, with case names and diagrams available on hover
- Training defaults to 20 rounds, with configurable round limits, automatic completion, and solve success rates
